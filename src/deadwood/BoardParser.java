...
public class BoardParser extends XMLParser {
    ...
    private void setupCastingOffice(Document doc) {
        ...
        Board.getInstance().getRoomsOnBoard().put("castingoffice", castingOffice);
    }
    ...
    private void setupPlayableRooms(Document doc) {
        ...
        for (int i = 0; i < sets.getLength(); i++) {
            ...
            Board.getInstance().getRoomsOnBoard().put(setName.toLowerCase(), room);
        }
    }
    ...
    private void setupTrailerRoom(Document doc) {
        ...
        Board.getInstance().getRoomsOnBoard().put("trailer", trailer);
    }
